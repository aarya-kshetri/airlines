	...
	<div class="container_12">
        ...
        <div class="content">
			...
			<div class="re-list">
                ...
                <div class="re-item">        	
	                <div class="re-image">
                    	<a href="tour-packages.html"><img src="images/temp/dashain.jpg" alt="" height="170"width="240"><span class="caption">View More Details</span></a>
                    </div>
                    
	                <div class="re-short">            	
	                    <div class="re-top">
	                        <h2><a href="tour-packages.html">Festival</a></h2>
                            <div class="re-subtitle">Hotel: <strong>Grand Mercure Sentosa 4*</strong> (5 nights)</div>
	                    </div>                
	                    <div class="re-descr">
	                        <p>The fifteen days of celebration occurs during the bright lunar fortnight 
                             ending on the day of the full moon. Thorough out the kingdom of Nepal the goddess Durga in all her manifestations are worshiped with innumerable pujas, abundant offerings and thousands of
                             animal sacrifices for the ritual holy bathing, thus drenching the goddess for days in blood.</p>
	                    </div>                	                    
	                </div>
					<div class="re-bot">
                ...
                <div class="re-item">        	
	                <div class="re-image">
                    	<a href="tour-packages.html"><img src="images/temp/new-year.jpg" alt=""height="170"width="240"><span class="caption">View More Details</span></a>
                    </div>
                    
	                <div class="re-short">            	
	                    <div class="re-top">
	                        <h2><a href="tour-packages.html">New Year</a></h2>
                            
	                    </div>                
	                    <div class="re-descr">
	                        <p>The celebration of the new year on January 1st is a relatively new phenomenon.
                            New Year’s Day is a national holiday celebrated on January 1st, the first day of the New Year,
                             following both the Gregorian and the Julian calendar.  </p>
	                    </div>               	                    
	                </div>
					<div class="re-bot">
                ...
                <div class="re-item">        	
	                ...
	                <div class="re-short">            	
	                    <div class="re-top">
	                        <h2><a href="tour-packages.html">Tour</a></h2>
                ...
                <div class="re-item">        	
	                ...
	                <div class="re-short">            	
	                    <div class="re-top">
	                        <h2><a href="tour-packages.html">Honeymoon</a></h2>                           
